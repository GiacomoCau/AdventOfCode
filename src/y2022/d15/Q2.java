...
public class Q2 {
	...
	public static void main(String[] args) throws Exception {
        ...
        for (var r=0; r<=4000000; r+=1) {
				var rng = rowRange(ls,r);
				if (rng.size() == 1) continue;
				System.out.println((rng.get(0).mx+1) * 4_000_000l + r);
				break;	
		}
	}
	...
	private static LinkedList<R> rowRange(List<S> ls, int r) {
		var lr = ls.stream()
			...
			.reduce(
				new LinkedList<R>(),
				(a,b)->{ if (a.isEmpty() || b.mn - a.getLast().mx > 1) a.add(b); else a.set(a.size()-1, new R(a.getLast().mn, max(a.getLast().mx, b.mx))); return a;},
